  ...
  <channel>
    ...
    <item>
      ...
      <description>
        ...
        <![CDATA[
          <br><hr><br>
          <p>Thanks for reading this post via RSS! If you have any feedback or comments to the post, you can reach me <a href="mailto:<?= kirby()->option('contactEmail'); ?>">here</a>.</p>
        ]]>
